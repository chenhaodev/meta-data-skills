"""Smoke tests for HealthBench pipeline.

Run: pytest skills/healthbench/tests/ -v
Note: All tests require HuggingFace network access and are marked @pytest.mark.slow.
      Run without network: pytest skills/healthbench/tests/ -v -m "not slow"
      For CI, mock pipeline.load_dataset() to return a local fixture DataFrame.
"""
import pytest
import sys
